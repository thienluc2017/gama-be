	...
	reflex update {
		...
		ask sFarm {
			...
			if aInfectedTime >= vCull * 7 {
				...
				list<list<sFarm>> vListRemove <- [];
				loop vPair over: vList {
					if (vPair contains myself) {
						add vPair to: vListRemove;					
						if (vPair at 0).aListSmall contains (vPair at 1) {
							remove item: (vPair at 1) from: (vPair at 0).aListSmall;
						} else if (vPair at 0).aListMedium contains (vPair at 1) {
							remove item: (vPair at 1) from: (vPair at 0).aListMedium;
						} else if (vPair at 0).aListLarge contains (vPair at 1) {
							remove item: (vPair at 1) from: (vPair at 0).aListLarge;
						}
						
						if (vPair at 1).aListSmall contains (vPair at 0) {
							remove item: (vPair at 0) from: (vPair at 1).aListSmall;
						} else if (vPair at 1).aListMedium contains (vPair at 0) {
							remove item: (vPair at 0) from: (vPair at 1).aListMedium;
						} else if (vPair at 1).aListLarge contains (vPair at 0) {
							remove item: (vPair at 0) from: (vPair at 1).aListLarge;
						}
					}
				}
				loop vPair over: vListRemove {
					remove item: vPair from: vList;
				}
				do die;
			}
		}
